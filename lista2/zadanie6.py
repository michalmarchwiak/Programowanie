def generuj_slupek(dzialanie):
    """input: działanie matematyczne
    output: słupek graficzny obliczający podane diałanie matematyczne
    funkcja generująca działanie graficzne dla podanego obliczenia"""
